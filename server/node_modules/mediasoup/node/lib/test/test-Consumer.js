...
test('Consumer emits "producerpause" and "producerresume"', async () => {
    ...
    await Promise.all([
        (0, enhancedEvents_1.enhancedOnce)(audioConsumer, 'producerpause'),
    ...
    await Promise.all([
        (0, enhancedEvents_1.enhancedOnce)(audioConsumer, 'producerresume'),
...
test('Consumer emits "producerclose" if Producer is closed', async () => {
    ...
    const onObserverClose = jest.fn();
    audioConsumer.observer.once('close', onObserverClose);
    const promise = (0, enhancedEvents_1.enhancedOnce)(audioConsumer, 'producerclose');
...
test('Consumer emits "transportclose" if Transport is closed', async () => {
    ...
    const promise = (0, enhancedEvents_1.enhancedOnce)(videoConsumer, 'transportclose');
